...
import sys
sys.path.append('C:\\Users\\Student\\Desktop\\上課筆記\\期末報告\\BDSE23_HM_recommedation\\flask\\app\\module')
import load_model 
...
article_df,customer_df,trans_df = load_cus_art_mapping.load_cus_art_mapping()
app = Flask(__name__)
